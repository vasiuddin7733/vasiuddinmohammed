export default function Home() {
  return (
    <div class="max-w-3xl mx-auto mt-10 space-y-8">
      <h1 class="text-4xl font-bold text-green-700 text-center">
        Vasiuddin Mohammed
      </h1>
      <p class="text-center text-lg">
        Full Stack Developer | JavaScript, TypeScript | Test Automation
        Enthusiast (ISTQB Certified)
      </p>
      ...
      <section>
        ...
        <div>
          <p>
            ...
            GraphQL, and Flutter. I build responsive, modular web & mobile
      ...
      <section>
        ...
        <ul class="list-disc list-inside space-y-2">
          ...
          <li>
            Data Science: Python, Pandas, NumPy, Scikit-learn, TensorFlow, Keras
          </li>
        </ul>
      </section>

      <section>
        <h2 class="text-2xl font-semibold text-green-700 mb-4">Contact</h2>
        <p>
          Email:{" "}
          <a
            href="mailto:vasiuddin.mohammed1@gmail.com"
            class="text-blue-600 underline"
          >
            vasiuddin.mohammed1@gmail.com
          </a>
        </p>
